 ...
 */
package alpe.bruno.avro.boleto;
...
public class BoletoAvro extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"BoletoAvro\",\"namespace\":\"alpe.bruno.avro.boleto\",\"fields\":[{\"name\":\"uuid\",\"type\":\"string\",\"default\":\"\"},{\"name\":\"linhaDigitavel\",\"type\":\"string\",\"default\":\"\"},{\"name\":\"valor\",\"type\":\"string\",\"default\":\"\"},{\"name\":\"numeroDocumento\",\"type\":\"string\",\"default\":\"\"},{\"name\":\"beneficiario\",\"type\":\"string\",\"default\":\"\"},{\"name\":\"dataVencimento\",\"type\":\"string\",\"default\":\"\"}]}");
   ...
   * @param linhaDigitavel The new value for linhaDigitavel
   * @param valor The new value for valor
   * @param numeroDocumento The new value for numeroDocumento
   * @param beneficiario The new value for beneficiario
   * @param dataVencimento The new value for dataVencimento
   */
   ...
   */
  public static alpe.bruno.avro.boleto.BoletoAvro.Builder newBuilder() {
    return new alpe.bruno.avro.boleto.BoletoAvro.Builder();
  }
   ...
   * @return A new BoletoAvro RecordBuilder
   */
  public static alpe.bruno.avro.boleto.BoletoAvro.Builder newBuilder(alpe.bruno.avro.boleto.BoletoAvro.Builder other) {
    if (other == null) {
      return new alpe.bruno.avro.boleto.BoletoAvro.Builder();
    } else {
      return new alpe.bruno.avro.boleto.BoletoAvro.Builder(other);
    }
  }
   ...
   * @return A new BoletoAvro RecordBuilder
   */
  public static alpe.bruno.avro.boleto.BoletoAvro.Builder newBuilder(alpe.bruno.avro.boleto.BoletoAvro other) {
    if (other == null) {
      return new alpe.bruno.avro.boleto.BoletoAvro.Builder();
    } else {
      return new alpe.bruno.avro.boleto.BoletoAvro.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<BoletoAvro>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(alpe.bruno.avro.boleto.BoletoAvro.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(alpe.bruno.avro.boleto.BoletoAvro other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.uuid)) {
        this.uuid = data().deepCopy(fields()[0].schema(), other.uuid);
    ...
    /**
      ...
      * @return This builder.
      */
    public alpe.bruno.avro.boleto.BoletoAvro.Builder setUuid(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public alpe.bruno.avro.boleto.BoletoAvro.Builder clearUuid() {
      uuid = null;
    ...
    /**
      * Sets the value of the 'linhaDigitavel' field.
      * @param value The value of 'linhaDigitavel'.
      * @return This builder.
      */
    public alpe.bruno.avro.boleto.BoletoAvro.Builder setLinhaDigitavel(java.lang.CharSequence value) {
    ...
    /**
      * Clears the value of the 'linhaDigitavel' field.
      * @return This builder.
      */
    public alpe.bruno.avro.boleto.BoletoAvro.Builder clearLinhaDigitavel() {
      linhaDigitavel = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public alpe.bruno.avro.boleto.BoletoAvro.Builder setValor(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public alpe.bruno.avro.boleto.BoletoAvro.Builder clearValor() {
      valor = null;
    ...
    /**
      * Clears the value of the 'beneficiario' field.
      * @return This builder.
      */
    ...
    /**
      * Sets the value of the 'dataVencimento' field.
      * @param value The value of 'dataVencimento'.
      * @return This builder.
      */
    ...
    /**
      * Checks whether the 'dataVencimento' field has been set.
      * @return True if the 'dataVencimento' field has been set, false otherwise.
      */
    ...
    /**
      * Clears the value of the 'dataVencimento' field.
      * @return This builder.
      */
